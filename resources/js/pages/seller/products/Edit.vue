...
<template>
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-zinc-950 transition-colors duration-300">
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 py-10">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-sm border border-zinc-200 dark:border-zinc-800">
                <form @submit.prevent="updateProduct" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" v-model="form.title" required class="w-full rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-3.5 focus:border-[#009933] outline-none dark:text-white">
                        ...
                        <div>
                            ...
                            <select v-model="form.category_id" required class="w-full rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-3.5 focus:border-[#009933] outline-none dark:text-white">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" v-model="form.price" required class="w-full rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-3.5 focus:border-[#009933] outline-none dark:text-white">
                        ...
                        <div>
                            ...
                            <input type="number" v-model="form.stock" required class="w-full rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-3.5 focus:border-[#009933] outline-none dark:text-white">
                    ...
                    <div>
                        ...
                        <textarea v-model="form.description" required rows="4" class="w-full rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-3.5 focus:border-[#009933] outline-none dark:text-white resize-none"></textarea>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-24 h-24 rounded-xl border-2 border-dashed border-zinc-300 dark:border-zinc-700 flex items-center justify-center overflow-hidden bg-zinc-50 dark:bg-zinc-800 shrink-0">
                                <img v-if="imagePreview" :src="imagePreview" class="w-full h-full object-cover">
                                <ImageIcon v-else class="w-8 h-8 text-zinc-400" />
                            </div>
                            <input type="file" @change="handleImageUpload" accept="image/*" class="text-sm text-zinc-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100 cursor-pointer">
                        </div>
                    ...
                    <div class="pt-6 border-t border-zinc-100 dark:border-zinc-800 flex justify-end">
                        <button type="submit" :disabled="form.processing" class="bg-[#009933] text-white px-8 py-3.5 rounded-xl font-bold hover:bg-green-700 transition-colors shadow-md flex items-center justify-center gap-2 disabled:bg-zinc-400">
