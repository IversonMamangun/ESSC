            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-64 shrink-0">
                    <div class="flex items-center gap-4 mb-8">
                        <div class="w-12 h-12 rounded-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center overflow-hidden border-2 border-white shadow-sm shrink-0">
                    ...
                    <nav class="space-y-1">
                        <Link href="/account" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-green-50 text-[#009933] font-black transition-colors">
                            <User class="w-5 h-5" /> My Profile
                        </Link>
                        <Link href="/account/address" class="flex items-center gap-3 px-4 py-3 rounded-xl text-zinc-600 hover:bg-zinc-100 font-bold transition-colors">
                ...
                <div class="flex-1 min-w-0">
                    <div class="bg-white dark:bg-zinc-900 rounded-3xl shadow-sm border border-zinc-200 p-6 md:p-10">
                        <div class="mb-8 pb-6 border-b border-zinc-100">
                            <h1 class="text-2xl font-black text-zinc-900">My Profile</h1>
                            <p class="text-zinc-500 mt-1">Manage your basic information</p>
                        </div>

                        <form @submit.prevent="submitProfile" class="flex flex-col-reverse lg:flex-row gap-12">
                            <div class="flex-1 space-y-6">
                                <div>
                                    <label class="block text-sm font-bold text-zinc-700 mb-2">Full Name</label>
                                    <input type="text" v-model="form.name" class="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 outline-none focus:border-[#009933]">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-zinc-700 mb-2">Email Address</label>
                                    <input type="email" v-model="form.email" class="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 outline-none focus:border-[#009933]">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-zinc-700 mb-2">Phone Number</label>
                                    <input type="text" v-model="form.phone" class="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 outline-none focus:border-[#009933]">
                                </div>
                            ...
                            <div class="lg:w-1/3 flex flex-col items-center border-l border-zinc-100 lg:pl-12">
                                <div class="relative group cursor-pointer mb-6">
                                    <div class="w-32 h-32 rounded-full bg-zinc-100 border-4 border-white shadow-lg overflow-hidden flex items-center justify-center">
                                        <img v-if="avatarPreview" :src="avatarPreview" class="w-full h-full object-cover" />
