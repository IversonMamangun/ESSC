  ...
  <div class="bg-[#009933] text-white py-10 px-6 md:px-10 lg:px-16 flex flex-col lg:flex-row justify-between items-center gap-10">
    ...
    <div class="flex flex-col sm:flex-row items-center gap-8 sm:gap-12 shrink-0">
      ...
      <div class="flex items-center gap-4">
        <div class="flex items-center justify-center w-12 h-12 bg-amber-50 rounded-full shrink-0">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-[#009933]">
